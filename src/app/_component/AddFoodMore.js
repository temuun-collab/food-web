...
// import { SelectIcon } from "../downicon/SelectIcon";
export const AddFoodMore = (props) => {
  ...
  return (
    <>
      <div className="w-[270px] h-[241px] border border-gray rounded-md flex justify-center items-center shadow-stone-600">
        <div className="flex flex-col gap-3">
          <div className="relative">
            ...
            />
            <button
              className="w-11 h-11 bg-white rounded-full flex justify-center items-center absolute z-10 ml-10 mb-20"
      ...
      {editFood && (
        <div className="w-[472px] h-[596px] bg-white rounded-md absolute  z-10 ml-80 border  flex flex-col justify-center items-center">
          ...
          <div className="w-[424px] h-[60px] flex items-center justify-between">
            ...
            <input className="w-[288px] h-9 border rounded-md text-black" />
          </div>
          <div className="w-[424px] h-[60px] flex items-center justify-between">
          ...
          <div className="w-[424px] h-[104px] flex items-center justify-between">
            ...
            <input className="w-[288px] h-20 border rounded-md text-black" />
          </div>
          <div className="w-[424px] h-[60px] flex items-center justify-between">
          ...
          <div className="w-[424px] h-[140px] flex items-center justify-between">
            ...
            <div className=" w-[288px] h-[116px] border-2 "></div>
          </div>
          <div className="w-[424px] h-16 flex justify-between items-end">
            <button className="w-12 h-10 border border-[#EF4444] rounded-md flex justify-center items-center">
              <TrashIcon />
            </button>
            <button
