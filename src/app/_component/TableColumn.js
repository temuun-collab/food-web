  ...
  return (
    <div className="w-[1171px] h-[52px] bg-[#F4F4F5CC] flex ">
      ...
      >
        ...
        {foodMore && (
          <div
            className="w-[263px] h-[97px] bg-white rounded-md border-1 border-gray flex justify-center items-center absolute top-12"
            onClick={() => {
              setFoodMore(false);
            }}
          >
      ...
      <div className="w-40] h-[52px] flex gap-5 items-center ">
        <div className="max-w-[115px] h-8 rounded-full border-1 border-gray flex justify-center items-center gap-2 p-3">
