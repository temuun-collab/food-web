  ...
  return (
    <div className="bg-white w-full h-[76px] flex justify-center items-center rounded-t-md mt-5 border-gray border-1">
      <div className="flex gap-35">
        <div className="w-[485px] h-11 flex flex-col">
          <p className="text-black text-[20px] font-bold ">Orders</p>
          <p className="text-[#71717A] text-[12px]">items</p>
        </div>
        <div className="w-[491px] h-9 flex justify-between">
          <div className="flex  gap-2">
            <div className="w-[300px] h-9 bg-white border-gray-50 flex justify-center items-center">
              <div className="flex justify-center w-[300px] h-9 gap-2 rounded-full mt-5 border-gray border items-center">
